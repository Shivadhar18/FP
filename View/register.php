			...
			<div class="tiles grey p-t-20 p-b-20 text-black">
				<form id="frm_register" method="post" class="animated fadeIn">    
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                      ...
                      <input type="text" name="firstname" id="firstname" required="required" class="form-control"  placeholder="First Name" autocomplete="off"/>
                      </div>
                      <div class="col-md-6 col-sm-12">
                      <input type="text" name="lastname" id="lastname" required="required" class="form-control"  placeholder="Last Name" autocomplete="off"/>
                      </div>
                      <div class="col-md-12">
                      <input type="text" name="username" id="username" required="required" class="form-control"  placeholder="Username" autocomplete="off"/>
                      </div>
                      <div class="col-md-12">
                      <input type="email" name="email" id="email" required="required" class="form-control"  placeholder="Email" autocomplete="off"  />
                      </div>
                      <div class="col-md-12">
	                    <input type="password" name="password" id="password" required="required" class="form-control" placeholder="Password" autocomplete="off"/>
                      </div>
                      <div class="col-md-12 col-sm-12">
	                     <input type="submit" class="btn btn-primary btn-cons" id="login_toggle" value="Create" />
                                <?php require 'inc/msg.php' ?>
                      </div>
                    </div>
                    <div class="row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                    	<div class="col-md-12">
                    		<a href="<?=ROOT_URL?>?p=admin&amp;a=login">Back To Login</a>
                    	</div>
                    </div>
